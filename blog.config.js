...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jwzong', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '庐山烟雨浙江潮。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jwzong.com', // 网站地址
